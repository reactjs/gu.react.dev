...
જ્યારે તમે checkbox ક્લિક કરો છો, ત્યારે કાઉન્ટર state રિસેટ થાય છે. હાલમાં તમે `Counter` રેન્ડર કરો છો, પરંતુ `div`ના પ્રથમ ચાઈલ્ડમાંથી `div` ને `section`માં બદલી દેવામાં આવે છે. જ્યારે ચાઈલ્ડ `section` DOM માંથી હટાવાયું, ત્યારે તેની નીચેનો સંપૂર્ણ ટ્રી (જેમાં `Counter` અને તેનો state પણ શામેલ છે) નષ્ટ થઈ ગયો.
